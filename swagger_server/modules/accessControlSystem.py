...
class AccessControlSystem(object):
    ...
    def login_required(cls, redirect_to_login):
        ...
        def decp(view):
            def wrapped_view(*args, **kwargs):
                if (
                    g.get("accesscontrol") is None
                    or g.get("accesscontrol").get("identity") is None
                ):
    ...
    @classmethod
    def owner_required(
        cls, user_args="user_id", identity_error=("error", "identity error")
    ):
        """
            尚未完成
        """
...
>>>>>>> cea6dab4bcc3629ed0977a503d61c57ac64776c1
    ...
    def identity_required(
        cls, identity_required=None, identity_error=("error", "identity error")
    ):
        """
...
=======
        ...
        def wrapped_view(*args, **kwargs):
            ...
            if "U" in identity_required:
                ...
                identity["isprove"] is "P" and identity["identity"] in identity_required
            ):
                return cls(*args, **kwargs)
