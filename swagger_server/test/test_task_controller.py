...
class TestTaskController(BaseTestCase):
    ...
    def test_task_task_id_info_get(self):
        ...
        """
        response = self.client.open(
            "//task/{taskId}/info".format(taskId="taskId_example"), method="GET"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_task_task_id_job_put(self):
        ...
        """
        query_string = [("userId", "userId_example"), ("state", "state_example")]
        response = self.client.open(
            "//task/{taskId}/job".format(taskId="taskId_example"),
            method="PUT",
            query_string=query_string,
    ...
    def test_tasks_get(self):
        ...
        """
        query_string = [("pageId", 0), ("type", "default")]
        response = self.client.open("//tasks", method="GET", query_string=query_string)
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
